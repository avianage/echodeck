...
export default function BannedPage() {
    ...
    const isTimeout = userData.bannedUntil && new Date(userData.bannedUntil) > new Date();
                ...
                <div className="bg-[#111] border border-white/5 rounded-3xl p-8 space-y-6 text-left">
                    <div className="space-y-4">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <p className="text-xs font-black uppercase tracking-widest text-gray-500 mb-1">Reason</p>
                                <p className="text-white font-bold leading-relaxed">
                                    {userData.banReason || "Terms of Service violation or community guidelines breach."}
                                </p>
                            </div>
                        </div>
                        ...
                        {isTimeout && (
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <p className="text-xs font-black uppercase tracking-widest text-gray-500 mb-1">Duration</p>
                                    <p className="text-white font-bold">
                                        Restricted until {new Date(userData.bannedUntil).toLocaleString()}
                                    </p>
                                </div>
                            </div>
                        )}

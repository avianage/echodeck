            ...
            <div className="min-h-screen bg-black flex items-center justify-center p-6">
                <Card className="bg-red-500/5 border-red-500/20 max-w-md w-full">
                    <CardContent className="p-8 text-center space-y-4">
                        ...
                        <p className="text-gray-400">The connection link is missing parameters or has expired.</p>
            ...
            <div className="w-full max-w-md space-y-8 animate-in fade-in zoom-in duration-700">
                <div className="space-y-4">
                    ...
                    <p className="text-gray-400 font-medium max-w-[280px] mx-auto">
                        Connecting your <span className="text-white font-bold">{provider}</span> account for <span className="text-white font-bold">{email}</span>...
                    </p>
                </div>
                ...
                <Card className="bg-gray-900/40 border-white/5 backdrop-blur-xl rounded-3xl overflow-hidden shadow-2xl">
                    <CardContent className="p-10 space-y-6">
                        ...
                        <p className="text-[10px] text-gray-500 font-medium leading-relaxed">
                            You'll be redirected to {provider} to complete the connection. 
                            This ensures your account remains secure.
                        </p>

                        <div className="pt-4 border-t border-white/5">
                            <p className="text-[9px] font-black text-gray-600 uppercase tracking-[0.2em]">
                                Not working? <button onClick={handleConnect} className="text-primary hover:underline ml-1">Click here to retry</button>
                            </p>
                        </div>
                    </CardContent>
                </Card>

      ...
      <div className="w-full max-w-md space-y-8 animate-in fade-in zoom-in duration-700">
        <div className="space-y-4">
          ...
          <p className="text-gray-400 font-medium">
            Your <span className="text-white font-bold">{displayProvider}</span> account is now
            linked.
          </p>
        ...
        <Card className="bg-gray-900/40 border-white/5 backdrop-blur-xl rounded-3xl overflow-hidden shadow-2xl">
          <CardContent className="p-8 space-y-4">
            ...
            <Link href="/account" className="block">
              <Button
                variant="ghost"
                className="w-full text-gray-400 hover:text-white hover:bg-white/5 font-bold py-6 rounded-2xl"
              >

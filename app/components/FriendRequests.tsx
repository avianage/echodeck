    ...
    return (
        <div className="space-y-4">
            ...
            <div className="space-y-2">
                {requests.map((req) => (
                    <div key={req.id} className="flex items-center justify-between p-3 bg-white/5 border border-white/5 rounded-2xl animate-in slide-in-from-right-2 duration-300">
                        <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center overflow-hidden shrink-0 border border-white/10">
                                {req.requester.image ? (
                                    <img src={req.requester.image} className="w-full h-full object-cover" />
                                ) : (
                            ...
                            <div className="min-w-0">
                                ...
                                <p className="text-[10px] text-gray-500 truncate">{req.requester.displayName || "Echoer"}</p>
                            </div>
                        </div>

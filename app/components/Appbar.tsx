...
export function Appbar() {
  ...
  return (
    <div
      className={`${isMobileHidden ? 'hidden' : 'flex'} md:flex flex-col md:flex-row justify-between items-center py-4 px-6 md:px-12 bg-black/40 backdrop-blur-xl border-b border-white/5 relative z-50`}
    >
      ...
      <div
        className={`${isMenuOpen ? 'flex' : 'hidden'} md:flex flex-col md:flex-row items-center w-full md:w-auto gap-6 mt-4 md:mt-0`}
      >
        <InstallPrompt />
        {session.data?.user && (

...
import { PlayCircle, ExternalLink, ShieldAlert } from "lucide-react";
                    ...
                    <div key={stream.id} className="p-6 hover:bg-white/[0.02] transition-colors">
                        <div className="flex items-start justify-between gap-4">
                            ...
                            <div className="flex items-center gap-2">
                                <Button variant="ghost" size="sm" className="h-8 w-8 p-0 rounded-full hover:bg-white/10" title="Join Silently">
                        ...
                        <div className="mt-4 flex items-center justify-between text-[10px] uppercase font-bold tracking-widest">
                            <span className={`flex items-center gap-1.5 ${stream.isLive ? "text-green-500" : "text-gray-500"}`}>
                                <span className={`w-1.5 h-1.5 rounded-full ${stream.isLive ? "bg-green-500 animate-pulse" : "bg-gray-500"}`} />

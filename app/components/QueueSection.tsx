...
export function QueueSection({ queue, currentUserId, creatorId, onVote, onRemove }: QueueSectionProps) {
    return (
                            ...
                            <CardContent className="p-3 flex items-center gap-4">
                                ...
                                <div className="flex items-center gap-1">
                                    {(video.addedById === currentUserId || creatorId === currentUserId) && (
                                        <Button variant="ghost" size="sm" onClick={() => onRemove(video.id)} className="h-8 w-8 p-0 text-gray-500 hover:text-red-500">
